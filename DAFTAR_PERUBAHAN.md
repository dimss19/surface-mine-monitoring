...
| 40 | **MODIFIED** | `resources/views/dashboard/export/pdf.blade.php` | Menampilkan laporan visual lengkap siap cetak dengan grafik operasional identik dashboard (Hauling by Material, Proporsi Pemakaian Donut, Gauge Availability/UoA, dan Kumulatif Ore) serta tabel data hauling murni (kolom tanda tangan/pengesahan dihapus). |
