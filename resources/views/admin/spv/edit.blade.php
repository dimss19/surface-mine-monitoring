@extends('layouts.app', ['headerTitle' => 'Edit SPV'])

@section('title', 'Edit SPV')

@section('content')
<div class="mb-6">
    <a href="{{ route('admin.spv.index') }}" class="btn-secondary inline-flex items-center gap-2">
...
<div class="card">
    <form method="POST" action="{{ route('admin.spv.update', $spv) }}">
        ...
        <div class="p-6 space-y-4">
            ...
            <div>
                <label for="password" class="form-label">Password <span class="text-slate-400 font-normal">(Kosongkan jika tidak ingin mengubah)</span></label>
                <input type="password"
                       id="password"
                       name="password"
                       class="form-input">
