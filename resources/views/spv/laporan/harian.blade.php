...
@section('title', 'Laporan Harian SPV')

@section('content')
<div class="mb-6">
    <h1 class="text-2xl font-bold text-[var(--primary)]" style="font-family: 'Plus Jakarta Sans', sans-serif;">Laporan Harian</h1>
    <p class="text-slate-500">Data ritasi dan non-ritasi per hari.</p>
</div>

<div class="bg-white rounded-xl border border-slate-200 p-6">
    <div class="flex items-center gap-4 mb-6">
        <form method="GET" class="flex items-center gap-3">
            <input type="date" name="tanggal" value="{{ $date }}" class="px-4 py-2 border border-slate-300 rounded-lg">
