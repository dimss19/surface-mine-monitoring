        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <span class="font-bold text-xl text-blue-600 tracking-tight">Surface Mine</span>
                    <span class="ml-2 px-2 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded">v1.0</span>
                </div>
                <div class="flex items-center space-x-4">
                    @auth
                        <span class="text-sm text-gray-700 hidden sm:inline-block">Halo, {{ auth()->user()->name }}</span>
                    ...
                    @guest
                        @if(!request()->routeIs('login'))
                            <a href="{{ route('login') }}" class="text-sm font-medium text-blue-600 hover:text-blue-500">Login SPV/Admin</a>
                        @endif
                    @endguest
                </div>
            </div>
